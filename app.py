...
app.layout = html.Div(children=[
    ...
    dbc.Container(children=[
        dbc.Row(children=[
            ...
            html.P("Education is the cornerstone of personal empowerment and societal development. It equips individuals with the necesary knowledge, critical thinking skills and essentially the ability to adapt."),
            html.P("There are almost 2,300 higher education institutions in the Philippines, the majority of which are private. Many universities are affiliated with Roman Catholicism, which reflects the country's colonial past")
        ]),
        dbc.Row(children=[
...
def display_map(selected_value, selected_type):
    if 'amenity' == selected_type:
        ...
        map_fig = px.choropleth_mapbox(amenity_gdf_indexed,
        ...
        map_fig = px.choropleth_mapbox(operatorty_gdf_indexed,
                           geojson=operatorty_gdf_indexed.geometry,
                           locations=operatorty_gdf_indexed.index,
                           color=selected_value,
                           center={'lat': 12.099568, 'lon': 122.733168},
                           zoom=4,
                           height=800)
